...
//        holder.tennguoidathang.setText(Utils.user.getUsername());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        TextView idDonhang,tennguoidathang,thoigiandathang,diachidathang;
        RecyclerView recyclerView_chitietdonhang;
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
//            tennguoidathang = itemView.findViewById(R.id.namenguoidathang);
